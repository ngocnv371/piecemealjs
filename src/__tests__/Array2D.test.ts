...
describe('Array2D()', () => {
  test('normal', () => {
    ...
    expect(array.bounds.toString()).toStrictEqual(new Rect(0, 0, 3, 2).toString());
    expect(array.size.toString()).toStrictEqual(new Vec(3, 2).toString());
  ...
  test('empty', () => {
    ...
    expect(array.bounds.toString()).toStrictEqual(new Rect(0, 0, 0, 0).toString());
    expect(array.size.toString()).toStrictEqual(new Vec(0, 0).toString());
  });
});
...
describe('Array2D.generated', () => {
  test('normal', () => {
    ...
    expect(array.bounds.toString()).toStrictEqual(new Rect(0, 0, 2, 3).toString());
    expect(array.size.toString()).toStrictEqual(new Vec(2, 3).toString());
    expect(array.get(0, 0)).toStrictEqual(0);
    expect(array.get(1, 2)).toStrictEqual(102);

    expect(calls.toString()).toBe([new Vec(0, 0), new Vec(1, 0), new Vec(0, 1), new Vec(1, 1), new Vec(0, 2), new Vec(1, 2)].toString());
  });
  ...
  test('1x1', () => {
    ...
    expect(array.bounds.toString()).toStrictEqual(new Rect(0, 0, 1, 1).toString());
    expect(array.size.toString()).toStrictEqual(new Vec(1, 1).toString());
    expect(array.get(0, 0)).toStrictEqual(0);
    expect(calls.toString()).toStrictEqual([new Vec(0, 0)].toString());
  });
});

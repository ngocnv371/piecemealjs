...
test("zero", () => {
  ...
  test("cardinalNeighbors", () => {
    expect(new Vec(3, 4).cardinalNeighbors).
    toEqual([new Vec(3, 3), new Vec(4, 4), new Vec(3, 5), new Vec(2, 4)]);
  });

  test("intercardinalNeighbors", () => {
    expect(new Vec(3, 4).intercardinalNeighbors).
    toEqual([new Vec(4, 3), new Vec(4, 5), new Vec(2, 5), new Vec(2, 3)]);
  });
